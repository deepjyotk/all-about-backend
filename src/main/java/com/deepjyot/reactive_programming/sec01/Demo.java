package com.deepjyot.reactive_programming.sec01;
/*
...
import com.deepjyot.reactive_programming.sec01.publisher.PublisherImpl;
...
public class Demo {
    ...
    private static void demo2() throws InterruptedException {
        ...
        //subscriber will use subscriptuon to request data!
        subscriber.getSubscription().request(3);
